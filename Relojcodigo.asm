...
;INTEGRANTES:
;
;Martínez Gamboa Erika
;Becerra López Grauben
;Caracheo Meza Eduardo Ulises
;Cruz Cambray José Eduardo
;
;COMENTARIO DE LO QUE EL PROGRAMA EJECUTARA: EL PROGRAMA REPRESENTARÁ LA FUNCION DE UN RELOJ MILITAR CAPAZ DE HACER UN CONTEO DEL TIEMPO EN SEGUNDOS, MINUTOS Y HORAS. MIDE EL TIEMPO
;QUE UN DIA (24 HORAS) ABARCA Y CUANDO SE CUMPLE ESTE LAPSO DE TIEMPO EL CUENTA SE REINICIA.
;--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
